...
const CraftItemsSection = () => {
  ...
  return (
    <div className="pb-14">
      <div>
        <h1 className="text-3xl md:text-5xl text-center pt-10 md:pt-20 font-bold text-slate-700 pb-2">
          Craft Items Section
        </h1>
        <p className="max-w-[700px] mx-auto text-center text-slate-500">
      ...
      <div className="mt-14 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div className="rounded-lg border-2 border-firstColor w-full min-h-72 p-2 hover:shadow-lg duration-150">
          ...
          <div className="">
            ...
            <h1 className="text-2xl font-bold text-slate-700 pb-3">
